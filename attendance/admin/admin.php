	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
				...
				<div class = "modal-dialog" role = "document">
					<div class = "modal-content panel-primary">
						<div class = "modal-header panel-heading">
							<button type = "button" class = "close" data-dismiss = "modal" aria-label = "Close" style="background-color: DodgerBlue;"><span aria-hidden = "true">&times;</span></button>
			...
			<div class = "well col-lg-12">
				<button type = "button" class = "btn btn-success" data-target = "#myModal" data-toggle = "modal" style="background-color: DodgerBlue;"><span class = "glyphicon glyphicon-plus"></span> Add new</button>
				<br />
				<br />
