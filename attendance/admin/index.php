					...
					<div class = "panel panel-primary">
						...
						<div class = "panel-body">
							<form enctype = "multipart/form-data">
								...
								<div id = "result"></div>
								<br />
								<button type = "button" class = "btn btn-success btn-block" id = "login_admin" style="background-color: DodgerBlue;"><span class = "glyphicon glyphicon-save"></span> Login</button>
							</form>
						</div>
					</div>
				</div>
